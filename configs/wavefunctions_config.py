...
class radial_bound_config:
    def __init__(self, max_r:float, n_radial_points:int, 
                 ...
                 k_values: str | int| tuple[int, int] | dict[int, list[int]],
                 radius_unit:str="bohr") -> None:
        self.max_r = max_r
...
class radial_scattering_config:
    def __init__(self, max_r:float, radius_unit:str, n_radial_points:int,
        ...
        self.ke_grid_type = ke_grid_type
...
class run_config:
    def __init__(self, config:dict) -> None:
        ...
        self.bound_config = radial_bound_config(max_r=config["bound_states"]["max_r"],
                                                n_radial_points=config["bound_states"]["n_radial_points"],
                                                n_values=n_values,
                                                k_values=k_values,
                                                radius_unit=config["bound_states"]["radius_unit"])
        
        k_values = config["scattering_states"]["k_values"]
        if (config["scattering_states"]["k_values"] == "auto"):
            k_values = [-1, 1]
            
        self.scattering_config = radial_scattering_config(max_r = config["scattering_states"]["max_r"],
                                                          radius_unit=config["scattering_states"]["radius_unit"],
                                                          ...
                                                          ke_grid_type=config["scattering_states"]["ke_grid_type"],
                                                          k_values=k_values)